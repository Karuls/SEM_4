...
insert newTable (word) values ('Станок1'), ('Станок2'), ('Станок3'), ('Станок4');
...
begin try
	begin tran						-- начало явной транзакции (внизу просто удаление и вставка)
		delete Студенты  where Студенты.Оценка = 4;
		insert into Студенты values(11,'Греневич Владислав Олегович','2006-04-04', 'БИ-227', '5');
		update Студенты set Студенты.Оценка = '15' where Студенты.ФИО='Греневич Владислав Олегович';
	commit tran;
end try
...
begin try
	begin tran
		delete Студенты where Студенты.ФИО = 'Греневич Владислав Олегович';									
		set @savepoint = 'save1'; save transaction @savepoint; -- КТ - 1

		insert into Студенты values('','Чемурако Иван Олегович','14-08-2025', 'БИ-228', '2');					
		set @savepoint = 'save2'; save transaction @savepoint; -- КТ - 2

		update Студенты set Студенты.Оценка = '5' where Студенты.ФИО = 'Чемурако Иван Олегович';		
