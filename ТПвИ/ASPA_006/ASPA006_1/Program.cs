...
internal class Program
{
    ...
    {
        string CS = "Server=DESKTOP-75R24I1; Database=Lab6; Trusted_Connection=true; TrustServerCertificate=Yes";
        ...
        {
            // ѕолучаем настройки из конфигурационного файла через механизм IOptions.
        ...
        celebrities.MapGet("/photo/{fname}", async (IRepository repo, string fname) =>
        {
            ...
            else
            {
                try
                {
                    ...
                    return Results.File(bytes, contentType);//¬озвращаем файл как HTTP-ответ с правильным типом содержимого
                }
                catch (Exception ex)
                {
